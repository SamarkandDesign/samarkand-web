...
class CountriesTest extends TestCase
{
  ...
  public function it_gets_a_list_of_countries_from_the_rest_api()
  {
    ...
    $client
      ...
      ->once()
      ->with('GET', 'https://restcountries.eu/rest/v1/all')
      ->andReturn($country_response);
  ...
  {
    $mocked_country_repository = Mockery::mock(CountryRepository::class, [
      'pluck' => [0 => 'United Kingdom'],
    ]);

...
Route::get('shop/{product_category?}', [
  'uses' => 'ShopController@index',
  'as' => 'products.index',
]);
Route::get('shop/{product_category}/{listed_product_slug}', [
...
Route::get('checkout/shipping', [
  'uses' => 'ShippingMethodsController@show',
...
Route::get('order-completed/{order}', ['uses' => 'OrdersController@completed', 'as' => 'orders.completed']);

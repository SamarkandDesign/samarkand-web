...
Route::post('orders/{order}/dispatch_confirmations', [
  'uses' => 'DispatchConfirmationsController@create',
  'as' => 'admin.dispatch_confirmations.create',
]);

// Shipping Methods
Route::group(['prefix' => 'shipping-methods'], function () {
  Route::get('/', [
    'uses' => 'ShippingMethodsController@index',
    'as' => 'admin.shipping_methods.index',
  ]);
  Route::post('/', [
    'uses' => 'ShippingMethodsController@store',
    'as' => 'admin.shipping_methods.store',
  ]);
  Route::get('/{shipping_method}/edit', [
    'uses' => 'ShippingMethodsController@edit',
    'as' => 'admin.shipping_methods.edit',
  ]);
  Route::patch('/{shipping_method}', [
    'uses' => 'ShippingMethodsController@update',
    'as' => 'admin.shipping_methods.update',
  ]);
  Route::delete('/{shipping_method}', [
    'uses' => 'ShippingMethodsController@destroy',
    'as' => 'admin.shipping_methods.delete',
  ]);
});
...
Route::group(['prefix' => 'products'], function () {
  ...
  Route::put('/{trashedProduct}/restore', [
    'uses' => 'ProductsController@restore',
    'as' => 'admin.products.restore',
  ]);

  Route::delete('/{trashedProduct}', [
    'uses' => 'ProductsController@destroy',
    'as' => 'admin.products.delete',
  ]);
  Route::get('upload', [
    'uses' => 'ProductImportsController@show',
    'as' => 'admin.products.upload',
  ]);
  Route::post('upload', [
    'uses' => 'ProductImportsController@create',
    'as' => 'admin.products.upload',
  ]);
});
...
Route::get('categories', [
  'uses' => 'TermsController@categoriesIndex',
  'as' => 'admin.categories.index',
]);
Route::get('categories/{term}/edit', [
  'uses' => 'TermsController@edit',
  'as' => 'admin.categories.edit',
]);
Route::patch('categories/{term}', [
  'uses' => 'TermsController@update',
...
Route::get('menus/{menu_item}/edit', [
  'uses' => 'MenuItemsController@edit',
  'as' => 'admin.menus.edit',
]);
Route::patch('menus/{menu_item}', [
  'uses' => 'MenuItemsController@update',
  'as' => 'admin.menus.update',
]);
Route::delete('menus/{menu_item}', [
...
Route::group(['prefix' => 'users'], function () {
  ...
  Route::get('{user}', ['uses' => 'UsersController@edit', 'as' => 'admin.users.edit'])->where(
    'user',
    '[0-9]+'
  );
  ...
  Route::get('{username}/orders', [
    'uses' => 'UsersController@orders',
    'as' => 'admin.users.orders',
  ]);
  Route::get('{username}/addresses', [
    'uses' => 'UsersController@addresses',
    'as' => 'admin.users.addresses',
  ]);
});

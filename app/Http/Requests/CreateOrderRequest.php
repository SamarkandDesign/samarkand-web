...
class CreateOrderRequest extends Request
{
  ...
  public function messages()
  {
    ...
    foreach (Address::$rules as $field => $rule) {
      $messages->put(
        "address.billing.$field.required",
        sprintf('The billing address %s is required.', str_replace('_', ' ', $field))
      );
      $messages->put(
        "address.shipping.$field.required",
        sprintf('The shipping address %s is required.', str_replace('_', ' ', $field))
      );
    }

...
class AddToCartRequest extends Request
{
  ...
  public function messages()
  {
    $message = $this->qty_in_cart
      ? sprintf(
        'There are %s in stock and you already have %s in your cart.',
        $this->qty_in_stock,
        $this->qty_in_cart
      )
  ...
  protected function getAvailableQuantity()
  {
    ...
    $alreadyAddedProducts = \Cart::search(function ($cartItem) {
      return intval($cartItem->model->id) === intval($this->product_id);
    });

...
class AttributeQueryBuilder
{
  ...
  {
    return array_key_exists($filter, $this->currentFilters) and
      (is_null($value) or $this->currentFilters[$filter] === $value);
  }
  ...
  {
    return isset($this->filters[$key]) and
      isset($this->currentFilters[$key]) and
      $this->filters[$key] === $this->currentFilters[$key];
  }
}

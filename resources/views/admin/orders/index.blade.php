...
<div class="nav-tabs-custom">
    ...
    <ul class="nav nav-tabs">
        ...
        <li role="presentation"
            class="{{ $currentUrl === ($url = route('admin.orders.index', $status)) ? 'active' : '' }}">
    ...
    <div class="tab-content">
        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('admin.orders.show', $order) }}"><strong>#{{ $order->id }}</strong></a> from
                        <a href="{{ route('admin.users.edit', $order->user) }}">{{ $order->user->name }}</a><br>
                        {{ $order->email }}
                    </td>
        ...
        <!-- Pagination -->
        {!! $orders->render('vendor.pagination.admin') !!}
        @else
        <p>
            No orders yet...
        </p>

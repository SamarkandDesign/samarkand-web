...
<!--         <ol class="carousel-indicators hidden-xs" v-show="indicators">
            <indicator :indicator="indicator" :active-index="activeIndex" :is-animating="isAnimating"></indicator>
        </ol> -->
        <!-- Wrapper for slides -->
...
export default {
    ...
    components: {
        ...
        //     template: '<li v-for="i in (indicator, index)" @click="handleIndicatorClick(index)" v-bind:class="indicatorClass(index)"><span></span></li>',
        //     methods: {
